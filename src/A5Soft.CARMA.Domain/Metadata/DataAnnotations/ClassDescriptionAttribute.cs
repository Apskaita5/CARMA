...
namespace A5Soft.CARMA.Domain.Metadata.DataAnnotations
{
    ...
    public class ClassDescriptionAttribute : Attribute
    {
        ...
        /// <para>
        /// Consumers must use the <see cref="NameForNew"/> method to retrieve the UI display string.
        /// </para>
        /// </summary>
        /// <remarks>
        ...
        /// name for display.
        /// <para>
        /// The <see cref="NameForNew"/> method will return either the literal, non-localized
